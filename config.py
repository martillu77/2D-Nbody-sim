...
LEFT_PERCENTAGE = 0.7     # Fraction of screen width used for the "world" (left panel)
HIGHT_PERCENTAGE = 0.8    # Fraction of screen height used
LEFT_X = 0
LEFT_Y = 0
...
PART_CFR = 0.1            # Contact interaction radius (in simulation units). Can be overridden in particle definition
...
def init():
    ...
    global WIDTH, HEIGHT, LEFT_WIDTH, RIGHT_WIDTH, LEFT_X, LEFT_Y,   LPIXELS_PER_UNIT, RPIXELS_PER_UNIT, RPIXELS_PER_UNIT_V, BOUNDS, RIGHT_X, RIGHT_Y, RIGHT_VX, RIGHT_VY, TYPICAL_M, TYPICAL_T  # DT_SAMPLE, FPS
...
#    print(f"LPIXELS_PER_UNIT: {LPIXELS_PER_UNIT}  RPIXELS_PER_UNIT: {RPIXELS_PER_UNIT}   RPIXELS_PER_UNIT_V: {RPIXELS_PER_UNIT_V} ")
...
#        PARTICLE_RAD = 1
    ...
    print(f"Left screen width: {LEFT_WIDTH}\n")
